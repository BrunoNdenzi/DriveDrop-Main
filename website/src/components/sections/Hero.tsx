          ...
          <div className="space-y-8 animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                asChild 
                size="lg" 
                className="gradient-primary text-lg px-8 py-6 hover-lift group shadow-lg shadow-primary/20"
              >
                <Link href="/#quote">
                  Get Instant Quote 
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-sm">
                  <div className="font-bold">1,000+ Drivers</div>
                  <div className="text-muted-foreground text-xs">Verified & Insured</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-muted-foreground text-xs">10,000+ Reviews</div>
                </div>
              </div>
            </div>
          </div>
