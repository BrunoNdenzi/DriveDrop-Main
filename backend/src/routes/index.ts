...
import driverRouteLifecycleRoutes from './driverRouteLifecycle.routes';
...
router.get('/', (_req, res) => {
  res.json({
    ...
    services: {
      ...
      driverRoutes: '/api/v1/driver-routes',
...
router.use('/driver-routes', driverRouteLifecycleRoutes);
