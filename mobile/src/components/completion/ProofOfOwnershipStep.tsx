    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.notesSection}>
        ...
        <View style={styles.notesList}>
          <Text style={styles.noteItem}>• Documents must be clear and readable</Text>
          <Text style={styles.noteItem}>• Ensure all text and details are visible</Text>
          <Text style={styles.noteItem}>• Documents must be current and valid</Text>
          <Text style={styles.noteItem}>• Name on documents must match the customer name</Text>
        </View>
      </View>
    </ScrollView>
  );
