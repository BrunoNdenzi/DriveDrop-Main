      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.pricingNotes}>
          <Text style={styles.noteText}>
            • Pricing is calculated based on distance, vehicle type, and service requirements
          </Text>
          <Text style={styles.noteText}>
            • Final price may vary based on actual conditions and fuel costs
          </Text>
          {isAccidentRecovery && (
            <Text style={styles.noteText}>
              • Accident recovery includes specialized handling and insurance
            </Text>
          )}
        </View>
      </View>
